...
readonly class UpdatePersonDTO implements Arrayable
{
    ...
    /**
     * The method creates UpdatePersonDTO from array.
     * @param array $data
     * @return self
     */
    ...
    /**
     * The method only receives data for person creation (excluding relationship keys).
